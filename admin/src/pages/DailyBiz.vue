...
<template>
  <div>
    ...
    >
      ...
      <div class="note">
        <div class="note-body">
          <p><b>口径：</b>营业额 = 金币消费 + 现场收款；充值额单独统计（充值只是资金进入，尚未消费，不计入营业额，避免双重计算）。<b>赠送金币消费不计收入</b>，故金币消费额按本金口径统计。</p>
          <p><b>到店人次口径：</b>仅统计当营业日有消费的注册会员去重数，<b>未注册顾客与纯现金客不计入，数值系统性偏小，仅供趋势参考</b>，不可用于测算人均消费。</p>
        </div>
      </div>
    </AppAsyncPage>
  </div>
