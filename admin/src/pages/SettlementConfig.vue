...
<template>
  <div class="settle-config-page">
    <div class="hdr"><span class="hdr-title">榜单与奖励规则</span><em class="hdr-note">影响 C 端榜单口径与周/月结算发放 · 仅老板可改</em></div>
